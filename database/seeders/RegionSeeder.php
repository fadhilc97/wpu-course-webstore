...
class RegionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach($provinces as $province) {
            ...
            $this->command->info("Fetching regencies for province {$province['name']} ...");
            ...
            foreach($regencies as $regency) {
                ...
                $this->command->info("Fetching districts for regency {$regency['name']} ...");
                ...
                foreach($districts as $district) {
                    ...
                    $this->command->info("Fetching villages for district {$district['name']} ...");

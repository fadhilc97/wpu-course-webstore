...
class ShippingMethodService
{
    ...
    {
        return collect($this->drivers)->first(fn (ShippingDriverInterface $shipping_driver) => $shipping_driver->driver === $service->driver);
    }
    ...
    public function getShippingServices(): DataCollection
    {
        return collect($this->drivers)
            ->flatMap(fn (ShippingDriverInterface $shipping_driver) => $shipping_driver->getServices()->toCollection())
    ...
    public function getShippingMethods(
        ...
        return $this->getShippingServices()->toCollection()
